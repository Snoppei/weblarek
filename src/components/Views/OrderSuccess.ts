...
export class OrderSuccess extends Component<IOrderSuccess> {
    ...
    constructor(protected events: IEvents, container: HTMLElement) {
        ...
        this.succesButtonElement = ensureElement<HTMLButtonElement>('.order-success__close', this.container);
        this.orderPriceElement = ensureElement<HTMLElement>('.order-success__description', this.container);
